...
int maxNode(TreeNode* root){
    ...
    }else if(root->child2->data>=root->child1->data && root->child2->data>=root->child3->data){
...
int main()
{
    ...
    cout<<endl;
    cout<<"The largest Node in the Tree is = "<<maxNode(root)<<endl;
    return 0;
}